...
namespace BitzArt
{
    ...
    {
        public static CustomApiException Custom(string message, HttpStatusCode statusCode, string? type = null, string? detail = null, string? instance = null, IDictionary<string, object?>? extensions = null)
